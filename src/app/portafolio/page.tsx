...
import { ExternalLink, Search, CheckCircle2, Cpu, Database, Code2 } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogHeader,
...
/**
 * Página de Portafolio con modal de detalles
 */
          ...
          {proyectoSeleccionado && (
            <div className="flex flex-col h-full max-h-[90vh]">
              <div className="relative h-64 md:h-80 w-full shrink-0">
                <Image 
                  src={PlaceHolderImages.find(p => p.id === proyectoSeleccionado.imagen)?.imageUrl || ''} 
                ...
                <div className="grid md:grid-cols-3 gap-12">
                  <div className="md:col-span-2 space-y-10">
                    <section className="space-y-4">
                      <h4 className="text-[10px] font-black text-secondary uppercase tracking-[0.3em] border-b border-gray-100 pb-2">Resumen del Proyecto</h4>
                    ...
                    <section className="space-y-6">
                      <h4 className="text-[10px] font-black text-secondary uppercase tracking-[0.3em] border-b border-gray-100 pb-2">Funcionalidades Clave</h4>
                    ...
                    <section className="space-y-4">
                      <h4 className="text-[10px] font-black text-secondary uppercase tracking-[0.3em] border-b border-gray-100 pb-2">Arquitectura & Lógica</h4>
                      <div className="bg-gray-50 p-6 border-l-4 border-black">
                        <div className="flex items-center gap-3 mb-4">
                          <Cpu className="h-5 w-5 text-black" />
                          <span className="font-headline font-bold text-black uppercase tracking-widest text-xs">Patrón de Diseño</span>
                        </div>
                  ...
                  <div className="space-y-10">
                    ...
                    <div className="pt-10 border-t border-gray-100 space-y-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-[9px] font-black text-secondary uppercase tracking-widest">Seguridad Garantizada</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Code2 className="h-4 w-4 text-accent" />
                        <span className="text-[9px] font-black text-secondary uppercase tracking-widest">Código Optimizado</span>
                      </div>
                    </div>
                  </div>
                </div>
